...
```json
{
    "orderSN": "5a38d03a60b6286d9c544f58",
...
| sign       | String | LTg1OTM3OTgyMTAwNTI4NTU4NzM= | 签名方式与接口计算签名一致                                           |
| orderId    | String | 5a38d03a60b6286d9c544f58     | 订单id                                                               |
...
```json
{
    ...
    "sign": "LTg1OTM3OTgyMTAwNTI4NTU4NzM=",
    "orderId": "0139d33c-5204-4a6a-8830-9947c6bee3c0",
